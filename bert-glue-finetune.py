...
parser = argparse.ArgumentParser(description="BERT GLUE Pruning + Post-Pruning Fine-Tuning")
...
parser.add_argument("--prune_steps", type=int, default=120,
                    help="Number of heads to prune before fine-tuning (default: 120 = 120/144 heads, ~83.3%%)")
...
# ---- Run ----
print("Running Greedy-Gnorm + Post-Pruning Fine-Tuning on SST-2...")
...
df.to_csv(f"experiments_results/finetune/BERT_sst2_gnorm_finetune_seed_{SEED}_{args.prune_steps}.csv", index=False)
...
df_summary.to_csv(f"experiments_results/finetune/BERT_sst2_gnorm_finetune_summary_seed_{SEED}_{args.prune_steps}.csv", index=False)
print(df_summary)
print("Done.")
