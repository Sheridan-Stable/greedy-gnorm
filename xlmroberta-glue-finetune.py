...
print("\n" + "="*50)
print("Completed setup and helper functions. Starting Task: SST2 (XLM-RoBERTa)...")
print("="*50 + "\n")
...
# ---- Run ----
print("Running Greedy-Gnorm + Post-Pruning Fine-Tuning on XLM-RoBERTa (SST-2)...")
...
df.to_csv(f"experiments_results/finetune/XLM_ROBERTA_sst2_gnorm_finetune_seed_{SEED}_{args.prune_steps}.csv", index=False)
...
df_summary.to_csv(f"experiments_results/finetune/XLM_ROBERTA_sst2_gnorm_finetune_summary_seed_{SEED}_{args.prune_steps}.csv", index=False)
print(df_summary)
print("Done.")
